...
def generate_html_report(
    ...
    for i, rec in enumerate(recommendations):
        ...
        if cat == "efficiency":
            ...
            if rem_val > 28:
                advice = f"你的做梦期占比 {rem_val:.0f}%，高于正常的 20-25%。这通常说明身体在「补觉」——之前可能睡眠不足或饮酒压制了做梦，身体正在把欠下的 REM 补回来。短期偏高一般不用太担心，但如果长期偏高且白天感觉疲惫，建议关注一下作息是否规律、是否有饮酒习惯。"
            else:
  ...
  <div class="section">
    ...
    <div style="background:#F5F0FF;border:1px solid #D4C8ED;border-radius:10px;padding:14px 18px;margin-top:14px;">
      ...
      <div style="color:#5D4037;font-size:0.92rem;line-height:1.8;">
        ...
        正常范围是占总睡眠的 <strong>20-25%</strong>。偏少（&lt;18%）常见于饮酒、压力大或作息紊乱；偏多（&gt;28%）通常说明身体在「补觉」——之前可能睡眠不足或饮酒压制了做梦，身体正在补回来。短期偏高无需紧张，长期偏高建议关注作息和饮酒习惯。
      </div>
    </div>
  </div>
